    ...
    if (this.editForm.valid) {
      if (this.selectedPicture != null && typeof this.selectedPicture !== 'object') {
        ...
        if (this.selectedPicture.startsWith('data:image/png;base64') || this.selectedPicture.startsWith('data:image/jpeg;base64')) {
          ...
          this.employee = new EditEmployee(new ProfileDto(null,
            this.editForm.controls.firstName.value, this.editForm.controls.lastName.value,
            this.editForm.controls.email.value, this.editForm.controls.password.value,
